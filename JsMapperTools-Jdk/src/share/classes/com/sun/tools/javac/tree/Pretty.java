...
public class Pretty extends JCTree.Visitor {
     ...
     *  (can be null)
     */
    protected DocCommentTable docComments = null;
    ...
    public static String toSimpleString(JCTree tree, int maxLength) {
        ...
        try {
        	...
        	JsUtils.getPretty(Pretty.class.getClassLoader(),
        			s, false).printExpr(tree);
        }
        catch (IOException e) {
...
//where
    ...
    // where
    protected boolean isUsed(final Symbol t, JCTree cdef) {
