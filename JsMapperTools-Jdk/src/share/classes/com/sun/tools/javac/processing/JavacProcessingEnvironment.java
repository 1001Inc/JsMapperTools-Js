...
public class JavacProcessingEnvironment implements ProcessingEnvironment, Closeable {
    ...
    protected final boolean werror;
    protected final boolean showResolveErrors;

    protected final JavacFiler filer;
    protected final JavacMessager messager;
    protected final JavacElements elementUtils;
    protected final JavacTypes typeUtils;
     ...
     */
    protected Set<PackageSymbol> specifiedPackages = Collections.emptySet();
    ...
    protected class Round {
        ...
        public List<JCCompilationUnit> roots;
        ...
        protected Round(Context context, List<JCCompilationUnit> roots, List<ClassSymbol> classSymbols,
                Log.DeferredDiagnosticHandler deferredDiagnosticHandler) {
        ...
        public Round next(Set<JavaFileObject> newSourceFiles, Map<String, JavaFileObject> newClassFiles) {
            try {
        ...
        public void run(boolean lastRound, boolean errorStatus) {
        ...
        public void showDiagnostics(boolean showAll) {
    ...
    protected void warnIfUnmatchedOptions() {
    ...
    protected static <T extends JCTree> List<T> cleanTrees(List<T> nodes) {
        for (T node : nodes)
