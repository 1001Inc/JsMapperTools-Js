...
public class Main {
     ...
     */
    protected void feMessage(Throwable ex) {
     ...
     */
    protected void ioMessage(Throwable ex) {
     ...
     */
    protected void resourceMessage(Throwable ex) {
     ...
     */
    protected void apMessage(AnnotationProcessingError ex) {
     ...
     * annotation processor.
     */
    protected void pluginMessage(Throwable ex) {
