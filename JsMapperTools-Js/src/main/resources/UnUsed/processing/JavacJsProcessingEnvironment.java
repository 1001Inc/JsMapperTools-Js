...
import static com.sun.tools.javac.main.Option.XPRINTPROCESSORINFO;
import static com.sun.tools.javac.main.Option.XPRINTROUNDS;
...
import com.sun.tools.javac.processing.JavacProcessingEnvironment.DiscoveredProcessors;
import com.sun.tools.javac.processing.JavacProcessingEnvironment.NameProcessIterator;
import com.sun.tools.javac.processing.JavacProcessingEnvironment.ProcessorState;
import com.sun.tools.javac.processing.JavacProcessingEnvironment.Round;
import com.sun.tools.javac.processing.JavacProcessingEnvironment.ServiceIterator;
import com.sun.tools.javac.processing.JavacProcessingEnvironment.DiscoveredProcessors.ProcessorStateIterator;
...
public class JavacJsProcessingEnvironment extends JavacProcessingEnvironment{
    ...
    public static JavacJsProcessingEnvironment instance(Context context) {
        ...
        return (JavacJsProcessingEnvironment) instance;
    }
            ...
            public ProcessorState next() {
                ...
                if (psi.processorIterator.hasNext()) {
                    ProcessorState ps = new ProcessorState(psi.processorIterator.next(),
                                                           log, source, JavacJsProcessingEnvironment.this);
    ...
    private void discoverAndRunProcs(Context context,
        ...
        RoundEnvironment renv = new JavacRoundEnvironment(false,
                                                          false,
                                                          rootElements,
                                                          JavacJsProcessingEnvironment.this);
    ...
    class Round {
        ...
        private Round(Context context, int number, int priorErrors, int priorWarnings,
            ...
            JavacJsProcessingEnvironment.this.context = context;
