...
public abstract class OptionHelperJs extends OptionHelper {
    ...
    public abstract void addClassName(String s);

    /** An implementation of OptionHelper that mostly throws exceptions. */
    public static class GrumpyHelper extends OptionHelperJs {
